...
if (!function_exists('respond')) {
    function respond(bool $success = true, mixed $data = null, string $message = 'Successful', int|StatusCode $code = StatusCode::OK, ?Meta $meta = null): JsonResponse
    {
...
if (!function_exists('unprocessable')) {
    ...
    {
        return respond(false, $data, $message, StatusCode::UNPROCESSABLE_ENTITY);
    }
}
