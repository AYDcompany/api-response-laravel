...
namespace Ayd\ApiResponseLaravel;
...
class ApiResponse
{
    ...
    public function fail(
        ...
        throw new HttpResponseException(
            $this->respond(false, $code, $data, $message, $meta),
        );
    }
    ...
    public function badRequest(
        ...
        throw new HttpResponseException(
            $this->respond(false, StatusCode::BAD_REQUEST, $data, $message),
        );
    }
    ...
    {
        throw new HttpResponseException(
            $this->respond(false, StatusCode::UNAUTHORIZED, null, $message),
        );
    }
    ...
    {
        throw new HttpResponseException(
            $this->respond(false, StatusCode::FORBIDDEN, null, $message),
        );
    }
    ...
    {
        throw new HttpResponseException(
            $this->respond(false, StatusCode::NOT_FOUND, null, $message),
        );
    }
